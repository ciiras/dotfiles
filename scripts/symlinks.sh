...
create_symlink "$DOT_FILES_DIR/bat/themes/nightfox.tmTheme" "$XDG_CONFIG_HOME/bat/themes/nightfox.tmTheme"
...
create_symlink "$DOT_FILES_DIR/nvim/ftplugin" "$XDG_CONFIG_HOME/nvim/ftplugin"
