...
export MODE_CURSOR_VIINS='#81B29A blinking bar'
export MODE_CURSOR_REPLACE="$MODE_CURSOR_VIINS #81B29A"
export MODE_CURSOR_VICMD='#81B29A blinking block'
export MODE_CURSOR_SEARCH='#81B29A steady underline'
export MODE_CURSOR_VISUAL="$MODE_CURSOR_VICMD steady underline"
export MODE_CURSOR_VLINE="$MODE_CURSOR_VISUAL #81B29A"
